...
\arg\max_{c} \sum_{i=1}^{M} \text{Amount of Say}_{T^{(i)}} \cdot \mathbb{I}(T^{(i)}(x) = c) & \text{classification}
\end{cases}
```
...
&= \dfrac{88+76+56}{3}\approx 73.33\\ \hline
r_1 &= y - F_0(x) \\
...
F_1(x_1) &= F_0(x_1) + \nu h_1(x_1)\\
&= 73.33 + 0.1 \cdot 8.7 \approx 74.6\\ \hline
r_2 &= y - F_1(x) \\
